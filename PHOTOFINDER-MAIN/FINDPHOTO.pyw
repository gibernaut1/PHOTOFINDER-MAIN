'''Программа берет фотографии из папки  photos  и сравнивает с фотографией find.jpg  и складывает фотографии где находиться это лицо в папку findphotos
работает довольно долго ,если много фото.Должны быть в папке с программой папки-photos,findphotos кроме того в папке с программой находится целевой файл
-find.jpg'''
import dlib
import os
import numpy as np
